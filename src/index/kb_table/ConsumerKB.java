...
public class ConsumerKB extends Thread {
	...
	public ConsumerKB(BlockingQueue<String> messageBuffer, BlockingQueue<String> responseBuffer,IndexWriter writer, DocsCounter docsCounter){
	...
	public void run() {
		...
		while(true){
			...
			if(message.equals(Message.FINISHED_PRODUCER)){
				...
				String relations = fieldsRecord[2];
